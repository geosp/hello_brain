...
var getExtremes = function getExtremes(data) {
  return _fp["default"].flow(_fp["default"].reduce(function (acc, _ref5) {
    var open = _ref5.open,
        high = _ref5.high,
        low = _ref5.low,
        close = _ref5.close;
...
var normalizeMarketData = function normalizeMarketData(data, extremes) {
  return processData({
    data: data,
    extremes: extremes,
    fn: normalize
...
var denormalizeMarketData = function denormalizeMarketData(data, extremes) {
  return processData({
    data: data,
    extremes: extremes,
    fn: denormalize
