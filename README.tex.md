...
1. [Machine Learning with Neural Networks in JavaScript](https://tinyurl.com/y6as8zhe)
...
4. [Neural Networks Deep Dive](https://www.youtube.com/playlist?list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi)
5. [Scrimba tutorial by Robert Plummer creator of Brain.JS](https://scrimba.com/g/gneuralnetworks) 
6. [Lodash](https://lodash.com/docs)
7. [Lodash FP](https://github.com/lodash/lodash/wiki/FP-Guide)
8. [futil-js](https://github.com/smartprocure/futil-js)
